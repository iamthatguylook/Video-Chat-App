...
export default function SignUp() {
  ...
  return (
    <SafeAreaView style={SafeAreaViewAndroid.AndroidSafeArea}>
      <View className="flex">
        <Text className="text-[48px] font-bold mt-60 mx-4 text-slate-50"> Sign Up</Text>
        <TextInput
      ...
      focus:outline-none focus:border-sky-500"
        ...
        <TouchableOpacity onPress={() => navigation.navigate("login")}>
          <Text className="text-[#03D7F4] ml-16 mt-4 font-extrabold">Already have an account? Sign In</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
