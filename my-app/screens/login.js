...
export default function LoginScreen() {
	return (
      ...
      focus:outline-none focus:border-sky-500"
				...
				/>
				<TextInput
					className=" block w-[338px]  mt-16 mx-8 px-3 py-3 bg-white border border-slate-300 rounded-md text-m shadow-sm placeholder:bold "
					placeholder="Password"
				/>
				<TouchableOpacity className="bg-[#FF2625] mx-20 p-[12px] mt-24 rounded-xl" onPress={() => Alert.alert("Simple Button pressed")}>
					<Text className="text-black ml-20 text-2xl font-extrabold">Login</Text>
				</TouchableOpacity>
				<TouchableOpacity>
					<Text className="text-[#03D7F4] ml-16 mt-8 font-extrabold">Don't have an account? Create an account</Text>
				</TouchableOpacity>
			</View>
		</SafeAreaView>
	);
